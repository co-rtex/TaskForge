...
// the pattern the API and publisher already use.
//
// Liveness reports only that the process exists. Readiness checks the one
// dependency reconciliation cannot work without, under a bounded timeout so a
// hung database cannot hang the probe.
