...
| [0013](0013-database-backed-api-key-authentication.md) | Database-backed API-key authentication | Accepted | 2026-09-13 | The public surface authenticates with scoped, revocable prefix-plus-hash keys; worker/control authentication is deferred, and what that costs is recorded. |
